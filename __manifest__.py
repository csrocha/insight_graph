# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'insight_graph/static/src/utils/insight_graph_pins.js',
            'insight_graph/static/src/search/pinned_nodes_menu.js',
            'insight_graph/static/src/search/pinned_nodes_menu.xml',
